<template>
    <div class="calendar-root">
        <div class="form-control" @click="callToggle"> {{getDateString(dateRange.start)}} -
            {{getDateString(dateRange.end)}}
        </div>
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            getDateString: function (date, format = this.format.toUpperCase(),) {
                if (!date) {
                    return null
                }
